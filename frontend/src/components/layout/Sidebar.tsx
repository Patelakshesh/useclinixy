...
export const Sidebar = ({ isOpen, setIsOpen }: SidebarProps) => {
  ...
  return (
    <aside className={`fixed left-0 top-0 z-40 h-screen w-64 border-r border-slate-200/60 bg-[#FAFAFA] dark:border-neutral-800/60 dark:bg-[#050505] transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 flex flex-col print:hidden`}>
